...
class AllSingleCategories extends StatefulWidget {
  String categoryId;

  AllSingleCategories({super.key, required this.categoryId});

  @override
  State<AllSingleCategories> createState() => _AllSingleCategoriesState();
}

class _AllSingleCategoriesState extends State<AllSingleCategories> {
  @override
